...
This repository documents my journey through the Stanford Machine Learning Specialization (DeepLearning.AI). As a Systems & Cybersecurity Engineer, I focus on understanding the underlying mechanics of AI—from mathematical foundations to vectorized implementations.
